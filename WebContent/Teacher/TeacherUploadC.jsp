...
<body>
	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        <legend>批量上传选择题</legend>
    </fieldset>	
    <div class="layui-form-item">		<!-- action -->
    <form class="layui-form" action="${pageContext.request.contextPath}/Teacher/uploadC" enctype="multipart/form-data" method="post" onsubmit="return check();">
    	<table>
    		<tr>
				<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
