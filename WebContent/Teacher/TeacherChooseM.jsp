...
<body>
    ...
    <form class="layui-form" action="">
        ...
        <thead>
            <tr>
                <th lay-data="{field:'mid', width:180, sort: true}">主观题号</th>
                <th lay-data="{field:'mtype', width:180}">主观题分类</th>
                <th lay-data="{field:'mque', width:180}">题目</th>
                <th lay-data="{field:'mans', width:180}">答案</th>
                <!-- 将选中选项放入 -->
