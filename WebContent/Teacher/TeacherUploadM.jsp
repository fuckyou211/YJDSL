...
<body>
	<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        <legend>批量上传主观题</legend>
    </fieldset>	
    <div class="layui-form-item">		<!-- action -->
    <form class="layui-form" action="${pageContext.request.contextPath}/Teacher/uploadM" enctype="multipart/form-data" method="post" onsubmit="return check();">
    	<table>
    		<tr>
				<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
