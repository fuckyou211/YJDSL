           ...
           for(int c = 0; c <=this.totalCells; c++){    
               ...
               if (null != cell){
                   if(c==0){//第一列不读
                	   ...
                	   problemc.setCtype(cell.getStringCellValue());//客户名称
                	   System.out.println(cell.getStringCellValue());
                   }else if(c==2){
                	   problemc.setCque(cell.getStringCellValue());//客户简称
                	   System.out.println(cell.getStringCellValue());
                   }else if(c==3){
                	   problemc.setCopt(cell.getStringCellValue());//行业
                	   System.out.println(cell.getStringCellValue());
                   }else if(c==4){
                	   problemc.setCans(cell.getStringCellValue());//客户来源
                	   System.out.println(cell.getStringCellValue());
                   }
               }
           }
